CREATE TABLE survey_forms(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE survey_logs(id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                                          form_id BIGINT NOT NULL,
...
CREATE TABLE survey_subscribers(id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                                                 form_id BIGINT NOT NULL,
                                                                                email VARCHAR(255) NOT NULL,
                                                                                                   username VARCHAR(32) NOT NULL,
                                                                                                                        created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP);
