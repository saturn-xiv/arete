CREATE TABLE survey_forms(id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE survey_fields(id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE survey_responses(id BIGSERIAL PRIMARY KEY,
                                                   form_id BIGINT NOT NULL,
...
CREATE TABLE survey_logs(id BIGSERIAL PRIMARY KEY,
                                              form_id BIGINT NOT NULL,
...
CREATE TABLE survey_subscribers(id BIGSERIAL PRIMARY KEY,
                                                     form_id BIGINT NOT NULL,
                                                                    email VARCHAR(255) NOT NULL,
                                                                                       username VARCHAR(32) NOT NULL,
                                                                                                            created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);
