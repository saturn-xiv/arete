...
CREATE TABLE links(id BIGSERIAL PRIMARY KEY,
                                        href VARCHAR(255) NOT NULL,
...
CREATE TABLE friend_links(id BIGSERIAL PRIMARY KEY,
                                               title VARCHAR(255) NOT NULL,
...
CREATE TABLE leave_words(id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE votes(id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE tag_resources(id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE category_resources(id BIGSERIAL PRIMARY KEY,
