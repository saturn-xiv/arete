...
CREATE TABLE logs(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE policies(id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                                       user_id BIGINT NOT NULL,
...
CREATE TABLE attachments(id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                                          user_id BIGINT NOT NULL,
