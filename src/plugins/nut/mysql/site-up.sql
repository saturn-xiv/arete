CREATE TABLE cards(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE links(id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                                    href VARCHAR(255) NOT NULL,
...
CREATE TABLE friend_links(id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                                           title VARCHAR(255) NOT NULL,
...
CREATE TABLE leave_words(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE votes(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE tags(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE tag_resources(id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE category_resources(id BIGINT AUTO_INCREMENT PRIMARY KEY,
